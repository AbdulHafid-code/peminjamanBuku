...
@section('container')
    ...
    <section id="materi" class="pt-24">
        ...
        <div class="flex flex-col items-center text-center px-4">
            ...
            <p class="mt-2 max-w-xl text-[12px] min-[420px]:text-sm md:text-[15px] text-gray-700 dark:text-gray-300">
            ...
            <form method="GET" class="mt-6 w-2/3">
                <div class="flex items-center gap-2 rounded-full bg-white/80 dark:bg-gray-800 backdrop-blur px-4 py-2 shadow-md transition focus-within:ring-2 focus-within:ring-violet-400">
        ...
        <div class="mt-10 px-4 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
          ...
          class="group block rounded-md
                  bg-white dark:bg-gray-800/50 shadow-md shadow-gray-200/60 dark:shadow-violet-800/20 hover:shadow-xl p-5
